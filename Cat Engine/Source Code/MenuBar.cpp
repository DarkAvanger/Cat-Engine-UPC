...
MenuBar::MenuBar() : Menu(true), saveWindow(false), buttonPlay(nullptr), buttonPause(nullptr), buttonNextFrame(nullptr), buttonStop(nullptr), buttonPauseBlue(nullptr)
{
	showMenu = false;
...
bool MenuBar::Start()
{
	buttonPlay = new Texture(-5, std::string("Settings/EngineResources/PlayButton.cattexture"));
	buttonPlay->Load();

	buttonStop = new Texture(-6, std::string("Settings/EngineResources/StopButton.cattexture"));
	buttonStop->Load();

	buttonPause = new Texture(-7, std::string("Settings/EngineResources/PauseButton.cattexture"));
	buttonPause->Load();

	buttonPauseBlue = new Texture(-8, std::string("Settings/EngineResources/PauseButtonActive.cattexture"));
	buttonPauseBlue->Load();

	buttonNextFrame = new Texture(-9, std::string("Settings/EngineResources/NextFrame.cattexture"));
